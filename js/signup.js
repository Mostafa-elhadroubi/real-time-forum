...
export const signup = () => {
    ...
    signupForm.addEventListener('submit', (e) => {
        ...
        submitsignupForm(emailError, passwordError, ageError)
...
const submitsignupForm = (emailError, passwordError, ageError, genderError) => {
    ...
    if(!regexEmail.test(email)){
        ...
        ageError.innerHTML = 'You must be at least 16 years old'
    }else if (!gender) {
